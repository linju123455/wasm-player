...
[ "_free", "__emscripten_thread_init", "__emscripten_thread_exit", "__emscripten_thread_crashed", "__emscripten_tls_init", "_pthread_self", "executeNotifiedProxyingQueue", "establishStackSpace", "invokeEntryPoint", "PThread", "_CreateProcessor", "_DestroyProcessor", "_ParsePacket", "_AsyncParsePacket", "_GetFrameData", "_GetFrameCacheData", "_FreeFrameData", "_GetBGR24Frame", "_GetBmpFrame", "_fflush", "__emscripten_proxy_execute_task_queue", "onRuntimeInitialized" ].forEach(prop => {
...
wasmBinaryFile = "ema-ws-decoder.wasm";
...
var PThread = {
 ...
 allocateUnusedWorker: function() {
  var worker;
  var pthreadMainJs = locateFile("ema-ws-decoder.worker.js");
...
function _fd_fdstat_get(fd, pbuf) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(9, 1, fd, pbuf);
 try {
  var stream = SYSCALLS.getStreamFromFD(fd);
...
var proxiedFunctionTable = [ null, _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall_fcntl64, ___syscall_openat, _environ_get, _environ_sizes_get, _fd_close, _fd_fdstat_get, _fd_read, _fd_seek, _fd_write ];
...
var _ParsePacket = Module["_ParsePacket"] = createExportWrapper("ParsePacket");

var _AsyncParsePacket = Module["_AsyncParsePacket"] = createExportWrapper("AsyncParsePacket");

var _GetFrameData = Module["_GetFrameData"] = createExportWrapper("GetFrameData");

var _GetFrameCacheData = Module["_GetFrameCacheData"] = createExportWrapper("GetFrameCacheData");

var _FreeFrameData = Module["_FreeFrameData"] = createExportWrapper("FreeFrameData");

var _GetBGR24Frame = Module["_GetBGR24Frame"] = createExportWrapper("GetBGR24Frame");

var _GetBmpFrame = Module["_GetBmpFrame"] = createExportWrapper("GetBmpFrame");
...
var _ff_h264_cabac_tables = Module["_ff_h264_cabac_tables"] = 3227989;
